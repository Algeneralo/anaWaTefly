...
@endsection
@section('body')
    <form action="{{route('sliders.update',$slider->id)}}" method="post" class="m-b-30" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-box"><h4 class="header-title m-t-0 mb-3">السلايدر</h4>
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="caption_ar" value="{{$slider->caption_ar}}">
                    </div>
                </div>
                <div class="form-group col-6">
                    <label class="mr-3" for="exampleInputEmail1">النص بالانجليزية</label>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="caption_en" value="{{$slider->caption_en}}">
                    </div>
                </div>
                <div class="col-12">
                    <div class="avatar-upload rectangle">
                        ...
                        <div class="avatar-preview">
                            <div id="imagePreview"
                                 style="background-image: url({{asset('assets/img/upload/'.$slider->image)}})">
                            </div>
                        </div>
                    </div>
                </div>
