...
@endsection
@section('body')
    <form action="{{route('directors.store')}}" method="post" class="m-b-30" enctype="multipart/form-data">
        @csrf
        <div class="card-box"><h4 class="header-title m-t-0 mb-3">مجلس الادارة</h4>
            <div class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="position_ar" value="{{old('position_ar')}}">
                    </div>
                </div>
                <div class="form-group col-6">
            ...
            <div class="col-12 form-inline">
                <div class="avatar-upload">
                    ...
                    <div class="avatar-preview">
                        <div id="imagePreview"
                             style="background-image: url('{{asset('assets/img/upload/staff.png')}}');">
                        </div>
                    </div>
                </div>
            </div>
