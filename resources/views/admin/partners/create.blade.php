...
@endsection
@section('body')
    <form action="{{route('partners.store')}}" method="post" class="m-b-30" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-12 form-inline">
                <div class="avatar-upload">
                    ...
                    <div class="avatar-preview">
                        <div id="imagePreview"
                             style="background-image: url('{{asset('assets/img/upload/partner-image.png')}}');">
                        </div>
                    </div>
                </div>
            </div>
